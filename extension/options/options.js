const PROFILE_FIELDS = ["first_name","last_name","email","phone","city","linkedin","github","website","school","degree","major","grad_term","gpa","work_authorized","needs_sponsorship","how_heard","background"];
function load(){
