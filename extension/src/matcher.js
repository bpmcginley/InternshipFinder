...
const RULES = [
  ...
  [/start date month|start month/, "edu_start_month"],
  [/start date year|start year/, "edu_start_year"],
  [/end date month|graduation month|end month/, "edu_end_month"],
  [/end date year|graduation year|end year/, "edu_end_year"],
  [/graduat/, "grad_term"],
  [/gpa/, "gpa"],
