...
export function fakeD1() {
  ...
  return {
    ...
    dump() {
      const out = {};
      for (const t of ["usage", "runs", "rate", "demand", "budget", "plans", "stripe_events", "spend", "tokens", "forget", "invite_codes", "referrals", "bonus", "accounts", "inviters"]) {
...
export function makeEnv(extra = {}) {
  return {
    ...
    ALLOWED_ORIGINS: "https://internscout.org,https://bpmcginley.github.io,http://localhost:8000,chrome-extension://jmjjgnckddhjbohfpbekodkpbpbmfjag,chrome-extension://hpnbbpmalfjijnmpoihhjgjolhabjpgi",
